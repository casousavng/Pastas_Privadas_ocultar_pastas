...
:PASSDESB1
set/p "pass=      Password: "
if NOT %pass%== cas13248792 goto FAILDESB1
...
:PASSDESB2
set/p "pass=      Password: "
if NOT %pass%== cas13248792 goto FAILDESB2
attrib -h -s "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}"
ren "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}" Pasta_Privada
echo.
@ECHO OFF
...
:PASSDESB3
set/p "pass=      Password: "
if NOT %pass%== cas13248792 goto FAILDESBMASTER
attrib -h -s "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}"
ren "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}" Pasta_Privada
echo.
@ECHO OFF
...
if NOT %pass%== cas13248792 goto FAILDESBALL
attrib -h -s "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}"
ren "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}" Pasta_Privada
echo.
@ECHO OFF
