...
COLOR F0
MODE 89,43
TITLE PASTAS PRIVADAS v1.2 scripted by Andre Sousa @ 18/09/2009
echo.
...
:PASSDESB1
set/p "pass=      Password: "
if NOT %pass%== andre1987 goto FAILDESB1
...
:PASSDESB2
set/p "pass=      Password: "
if NOT %pass%== andre1987 goto FAILDESB2
attrib -h -s "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}"
ren "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}" Pasta_Privada
echo.
@ECHO OFF
...
:PASSDESB3
set/p "pass=      Password: "
if NOT %pass%== andre1987 goto FAILDESBMASTER
attrib -h -s "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}"
ren "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}" Pasta_Privada
echo.
@ECHO OFF
...
if NOT %pass%== andre1987 goto FAILDESBALL
attrib -h -s "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}"
ren "Control Panel.{21EC2020-3AEA-1069-A2DD-08002B30309D}" Pasta_Privada
echo.
@ECHO OFF
...
echo.
set/p "pass=      Password: "
if NOT %pass%== andre1987 goto FAILCRIAR1
goto LOCK
...
echo.
set/p "pass=      Password: "
if NOT %pass%== andre1987 goto FAILCRIAR2
goto LOCK
...
echo.
set/p "pass=      Password: "
if NOT %pass%== andre1987 goto FAILCRIARALL
goto LOCK
